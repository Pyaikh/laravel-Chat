                ...
                @foreach($users as $user)
                    <div
                        ...
                        @class([
                          ...
                          // если выбран — синий фон и белый текст
                          'bg-blue-200 text-white font-semibold' => $selectedUser?->id === $user->id,
                          // если не выбран — просто hover
                          'hover:bg-blue-100' => $selectedUser?->id !== $user->id,
                        ])
                    >
